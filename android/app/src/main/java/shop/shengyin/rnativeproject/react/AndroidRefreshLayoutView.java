...
public class AndroidRefreshLayoutView extends ViewGroup implements RefreshLayout, NestedScrollingParent, NestedScrollingChild {
    ...
    public AndroidRefreshLayoutView(Context context) {
        super(context);
        this.initView(context, null);
    }

    public AndroidRefreshLayoutView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context, attrs);
    }

    public AndroidRefreshLayoutView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.initView(context, attrs);
    }

    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    public AndroidRefreshLayoutView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void setStateDirectLoading() {
        if (mState != RefreshState.Loading) {
            ...
            mFooterLocked = true;
            if (mRefreshFooter != null) {
                mRefreshFooter.onStartAnimator(AndroidRefreshLayoutView.this, mFooterHeight, mFooterExtendHeight);
            }
            if (mLoadmoreListener != null) {
                mLoadmoreListener.onLoadmore(AndroidRefreshLayoutView.this);
            }
            if (mOnMultiPurposeListener != null) {
                mOnMultiPurposeListener.onLoadmore(AndroidRefreshLayoutView.this);
    ...
    protected void setStateRefreshing() {
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mRefreshListener != null) {
                    mRefreshListener.onRefresh(AndroidRefreshLayoutView.this);
                }
                if (mRefreshHeader != null) {
                    mRefreshHeader.onStartAnimator(AndroidRefreshLayoutView.this, mHeaderHeight, mHeaderExtendHeight);
                }
                if (mOnMultiPurposeListener != null) {
                    mOnMultiPurposeListener.onRefresh(AndroidRefreshLayoutView.this);
...
//        }
    ...
    @Override
    public AndroidRefreshLayoutView setFooterHeight(float heightDp) {
        return setFooterHeightPx(dp2px(heightDp));
    }

    @SuppressLint("RestrictedApi")
    @Override
    public AndroidRefreshLayoutView setFooterHeightPx(int heightPx) {
    ...
    @Override
    public AndroidRefreshLayoutView setHeaderHeight(float heightDp) {
        return setHeaderHeightPx(dp2px(heightDp));
    }

    @SuppressLint("RestrictedApi")
    @Override
    public AndroidRefreshLayoutView setHeaderHeightPx(int heightPx) {
    ...
    @Override
    public AndroidRefreshLayoutView setDragRate(float rate) {
        this.mDragRate = rate;
        return this;
    }
    ...
    @Override
    @SuppressLint("RestrictedApi")
    public AndroidRefreshLayoutView setHeaderMaxDragRate(float rate) {
    ...
    @Override
    @SuppressLint("RestrictedApi")
    public AndroidRefreshLayoutView setFooterMaxDragRate(float rate) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setHeaderTriggerRate(float rate) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setFooterTriggerRate(float rate) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setReboundInterpolator(Interpolator interpolator) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setReboundDuration(int duration) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setEnableLoadmore(boolean enable) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setEnableRefresh(boolean enable) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setEnableHeaderTranslationContent(boolean enable) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setEnableFooterTranslationContent(boolean enable) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setDisableContentWhenRefresh(boolean disable) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setDisableContentWhenLoading(boolean disable) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setEnableAutoLoadmore(boolean enable) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setEnableOverScrollBounce(boolean enable) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setEnablePureScrollMode(boolean enable) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setEnableScrollContentWhenLoaded(boolean enable) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setEnableScrollContentWhenRefreshed(boolean enable) {
    ...
    @SuppressLint("RestrictedApi")
    @Override
    public AndroidRefreshLayoutView setEnableLoadmoreWhenContentNotFull(boolean enable) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setEnableOverScrollDrag(boolean enable) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setEnableFooterFollowWhenLoadFinished(boolean enable) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setRefreshHeader(RefreshHeader header) {
    ...
    @SuppressLint("RestrictedApi")
    @Override
    public AndroidRefreshLayoutView setRefreshHeader(RefreshHeader header, int width, int height) {
        if (header != null) {
            if (mRefreshHeader != null) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setRefreshFooter(RefreshFooter footer) {
    ...
    @SuppressLint("RestrictedApi")
    @Override
    public AndroidRefreshLayoutView setRefreshFooter(RefreshFooter footer, int width, int height) {
        if (footer != null) {
            if (mRefreshFooter != null) {
            ...
            if (mRefreshFooter.getSpinnerStyle() == SpinnerStyle.FixedBehind) {
                this.addView(mRefreshFooter.getView(), 0, new AndroidRefreshLayoutView.LayoutParams(width, height));
            } else {
    ...
    public RefreshLayout setRefreshContent(View content, int width, int height) {
        if (content != null) {
            ...
            addView(content, 0, new AndroidRefreshLayoutView.LayoutParams(width, height));
            if (mRefreshHeader != null && mRefreshHeader.getSpinnerStyle() == SpinnerStyle.FixedBehind) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView getLayout() {
        return this;
    }
     ...
     */
    @Override
    public AndroidRefreshLayoutView setOnRefreshListener(OnRefreshListener listener) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setOnLoadmoreListener(OnLoadmoreListener listener) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setOnRefreshLoadmoreListener(OnRefreshLoadmoreListener listener) {
        this.mRefreshListener = listener;
        this.mLoadmoreListener = listener;
        this.mEnableLoadmore = mEnableLoadmore || (!mManualLoadmore && listener != null);
        return this;
     ...
     */
    @Override
    public AndroidRefreshLayoutView setOnMultiPurposeListener(OnMultiPurposeListener listener) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView setPrimaryColorsId(@ColorRes int... primaryColorId) {
    ...
    @SuppressLint("RestrictedApi")
    @Override
    public AndroidRefreshLayoutView setPrimaryColors(int... colors) {
        if (mRefreshHeader != null) {
    ...
    @SuppressLint("RestrictedApi")
    @Override
    public AndroidRefreshLayoutView setLoadmoreFinished(boolean finished) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView finishRefresh() {
     ...
     */
    @Override
    public AndroidRefreshLayoutView finishLoadmore() {
     ...
     */
    @Override
    public AndroidRefreshLayoutView finishRefresh(int delayed) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView finishRefresh(boolean success) {
        long passTime = System.currentTimeMillis() - mLastRefreshingTime;
    ...
    @SuppressLint("RestrictedApi")
    @Override
    public AndroidRefreshLayoutView finishRefresh(int delayed, final boolean success) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (mState == RefreshState.Refreshing) {
                    if (mRefreshHeader != null && mRefreshContent != null) {
                        int startDelay = mRefreshHeader.onFinish(AndroidRefreshLayoutView.this, success);
     ...
     */
    @Override
    public AndroidRefreshLayoutView finishLoadmore(int delayed) {
     ...
     */
    @Override
    public AndroidRefreshLayoutView finishLoadmore(boolean success) {
        long passTime = System.currentTimeMillis() - mLastLoadingTime;
     ...
     */
    @Override
    public AndroidRefreshLayoutView finishLoadmore(int delayed, final boolean success) {
    ...
    @SuppressLint("RestrictedApi")
    @Override
    public AndroidRefreshLayoutView finishLoadmore(int delayed, final boolean success, final boolean noMoreData) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (mState == RefreshState.Loading) {
                    if (mRefreshFooter != null && mRefreshContent != null) {
                        final int startDelay = mRefreshFooter.onFinish(AndroidRefreshLayoutView.this, success);
                        if (startDelay < Integer.MAX_VALUE) {
                            if (mIsBeingDragged) {
                                mTouchSpinner = 0;
                                mTouchY = mLastTouchY;
     ...
     */
    @Override
    public AndroidRefreshLayoutView finishLoadmoreWithNoMoreData() {
        long passTime = System.currentTimeMillis() - mLastLoadingTime;
     ...
     */
    @Override
    public AndroidRefreshLayoutView resetNoMoreData() {
    ...
    public class RefreshKernelImpl implements RefreshKernel {
        ...
        public RefreshLayout getRefreshLayout() {
            return AndroidRefreshLayoutView.this;
        }
        ...
        public RefreshKernel setState(@NonNull RefreshState state) {
            switch (state) {
                case None:
                    AndroidRefreshLayoutView.this.resetStatus();
                    break;
                case PullDownToRefresh:
                    AndroidRefreshLayoutView.this.setStatePullDownToRefresh();
                    break;
                case PullToUpLoad:
                    AndroidRefreshLayoutView.this.setStatePullUpToLoad();
                    break;
                case PullDownCanceled:
                    AndroidRefreshLayoutView.this.setStatePullDownCanceled();
                    break;
                case PullUpCanceled:
                    AndroidRefreshLayoutView.this.setStatePullUpCanceled();
                    break;
                case ReleaseToRefresh:
                    AndroidRefreshLayoutView.this.setStateReleaseToRefresh();
                    break;
                case ReleaseToLoad:
                    AndroidRefreshLayoutView.this.setStateReleaseToLoad();
                    break;
                case ReleaseToTwoLevel: {
                    if (!AndroidRefreshLayoutView.this.mState.opening && AndroidRefreshLayoutView.this.isEnableRefresh()) {
                        AndroidRefreshLayoutView.this.notifyStateChanged(RefreshState.ReleaseToTwoLevel);
                    } else {
                        AndroidRefreshLayoutView.this.setViceState(RefreshState.ReleaseToTwoLevel);
                    }
                    break;
                }
                case RefreshReleased: {
                    if (!AndroidRefreshLayoutView.this.mState.opening && AndroidRefreshLayoutView.this.isEnableRefresh()) {
                        AndroidRefreshLayoutView.this.notifyStateChanged(RefreshState.RefreshReleased);
                    } else {
                        AndroidRefreshLayoutView.this.setViceState(RefreshState.RefreshReleased);
                    }
                    break;
                }
                case LoadReleased: {
                    if (!AndroidRefreshLayoutView.this.mState.opening && AndroidRefreshLayoutView.this.isEnableLoadmore()) {
                        AndroidRefreshLayoutView.this.notifyStateChanged(RefreshState.LoadReleased);
                    } else {
                        AndroidRefreshLayoutView.this.setViceState(RefreshState.LoadReleased);
                    }
                    break;
                }
                case Refreshing:
                    AndroidRefreshLayoutView.this.setStateRefreshing();
                    break;
                case Loading:
                    AndroidRefreshLayoutView.this.setStateLoding();
                    break;
                case RefreshFinish: {
                    if (AndroidRefreshLayoutView.this.mState == RefreshState.Refreshing) {
                        AndroidRefreshLayoutView.this.notifyStateChanged(RefreshState.RefreshFinish);
                    }
                    break;
                }
                case LoadFinish:{
                    if (AndroidRefreshLayoutView.this.mState == RefreshState.Loading) {
                        AndroidRefreshLayoutView.this.notifyStateChanged(RefreshState.LoadFinish);
                    }
                    break;
                }
            }
        ...
        public RefreshKernel startTwoLevel(boolean open) {
            if (open) {
                AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
                    @Override
                    public void onAnimationEnd(Animator animation) {
                        AndroidRefreshLayoutView.this.notifyStateChanged(RefreshState.TwoLevel);
                    }
                };
                ValueAnimator animator = AndroidRefreshLayoutView.this.animSpinner(AndroidRefreshLayoutView.this.getMeasuredHeight());
                if (animator != null && animator == AndroidRefreshLayoutView.this.reboundAnimator) {
                    animator.setDuration(AndroidRefreshLayoutView.this.mFloorDuration);
                    animator.addListener(listener);
                } else {
                    listener.onAnimationEnd(null);
                }
                ...
                if (animSpinner(0) == null) {
                    AndroidRefreshLayoutView.this.notifyStateChanged(RefreshState.None);
                }
            }
            return this;
        }
        ...
        public RefreshKernel finishTwoLevel() {
            if (AndroidRefreshLayoutView.this.mState == RefreshState.TwoLevel) {
                AndroidRefreshLayoutView.this.notifyStateChanged(RefreshState.TwoLevelFinish);
                if (AndroidRefreshLayoutView.this.mSpinner == 0) {
                    moveSpinner(0, true);
                    AndroidRefreshLayoutView.this.notifyStateChanged(RefreshState.None);
                } else {
                    AndroidRefreshLayoutView.this.animSpinner(0).setDuration(AndroidRefreshLayoutView.this.mFloorDuration);
                }
            }
            return this;
        }
        ...
        public RefreshKernel moveSpinner(int spinner, boolean isAnimator) {
            AndroidRefreshLayoutView.this.moveSpinner(spinner, isAnimator);
            return this;
        }

        public RefreshKernel animSpinner(int endSpinner) {
            AndroidRefreshLayoutView.this.animSpinner(endSpinner);
            return this;
        }
        ...
        public RefreshKernel requestDrawBackgoundForHeader(int backgroundColor) {
            if (AndroidRefreshLayoutView.this.mPaint == null && backgroundColor != 0) {
                AndroidRefreshLayoutView.this.mPaint = new Paint();
            }
            AndroidRefreshLayoutView.this.mHeaderBackgroundColor = backgroundColor;
            return this;
        }
        ...
        public RefreshKernel requestDrawBackgoundForFooter(int backgroundColor) {
            ...
            AndroidRefreshLayoutView.this.mFooterBackgroundColor = backgroundColor;
            return this;
        }
        @Override
        public RefreshKernel requestHeaderNeedTouchEventWhenRefreshing(boolean request) {
            AndroidRefreshLayoutView.this.mHeaderNeedTouchEventWhenRefreshing = request;
            return this;
        }
        @Override
        public RefreshKernel requestFooterNeedTouchEventWhenLoading(boolean request) {
            AndroidRefreshLayoutView.this.mFooterNeedTouchEventWhenLoading = request;
            return this;
        }
        @Override
        public RefreshKernel requestDefaultHeaderTranslationContent(boolean translation) {
            if (!AndroidRefreshLayoutView.this.mManualHeaderTranslationContent) {
                AndroidRefreshLayoutView.this.mManualHeaderTranslationContent = true;
                AndroidRefreshLayoutView.this.mEnableHeaderTranslationContent = translation;
            }
            return this;
        }
        @Override
        public RefreshKernel requestRemeasureHeightForHeader() {
            if (AndroidRefreshLayoutView.this.mHeaderHeightStatus.notifyed) {
                AndroidRefreshLayoutView.this.mHeaderHeightStatus = AndroidRefreshLayoutView.this.mHeaderHeightStatus.unNotify();
            }
            return this;
        }
        @Override
        public RefreshKernel requestRemeasureHeightForFooter() {
            if (AndroidRefreshLayoutView.this.mFooterHeightStatus.notifyed) {
                AndroidRefreshLayoutView.this.mFooterHeightStatus = AndroidRefreshLayoutView.this.mFooterHeightStatus.unNotify();
            }
            return this;
        }
        @Override
        public RefreshKernel requestFloorDuration(int duration) {
            AndroidRefreshLayoutView.this.mFloorDuration = duration;
            return this;
        }
        //</editor-fold>
    }
